<form class="form-horizontal" enctype="multipart/form-data" id="frmNuevoUsuario" action="<?php echo base_url() . "index.php/admin/crearusuario"; ?>" method="post">
  <div class="form-group">
    <label for="txtNombreUsuario" class="col-sm-3 control-label">Nombres</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtNombreUsuario" name="txtNombreUsuario" placeholder="Nombre del Usuario">
    </div>
  </div>
  <div class="form-group">
    <label for="txtApellidoUsuario" class="col-sm-3 control-label">Apellidos</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtApellidoUsuario" name="txtApellidoUsuario" placeholder="Apellidos del Usuario">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtEmailUsuario" name="txtEmailUsuario" placeholder="Email de Usuario">
    </div>
  </div>
  <div class="form-group">
