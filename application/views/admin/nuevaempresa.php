<form class="form-horizontal" enctype="multipart/form-data" id="frmNuevaEmpresa" action="<?php echo base_url() . "index.php/admin/crearempresa"; ?>" method="post">
  <div class="form-group">
    <label for="txtRucEmpresa" class="col-sm-3 control-label">RUC</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtRucEmpresa" name="txtRucEmpresa" placeholder="Numero RUC de la Empresa">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtRazonSocialEmpresa" name="txtRazonSocialEmpresa" placeholder="Nombre de la Raz&oacute;n Social">
    </div>
  </div>
  <div class="form-group">
    <label for="txtNombreComercialEmpresa" class="col-sm-3 control-label">Nombre Comercial</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtNombreComercialEmpresa" name="txtNombreComercialEmpresa" placeholder="Nombre Comercial">
    </div>
  </div>
  <div class="form-group">
    <label for="txtWebEmpresa" class="col-sm-3 control-label">Pagina Web</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtWebEmpresa" name="txtWebEmpresa" placeholder="http://www.empresa.com">
    </div>
  </div>
  <div class="form-group">
    <label for="txtNombreContactoEmpresa" class="col-sm-3 control-label">Nombre Contacto</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtNombreContactoEmpresa" name="txtNombreContactoEmpresa" placeholder="Nombre Contacto">
    </div>
  </div>
  <div class="form-group">
    <label for="txtAPaternoContactoEmpresa" class="col-sm-3 control-label">Apellido Paterno Contacto</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtAPaternoContactoEmpresa" name="txtAPaternoContactoEmpresa" placeholder="Apellido Paterno Contacto">
    </div>
  </div>
  <div class="form-group">
    <label for="txtAMaternoContactoEmpresa" class="col-sm-3 control-label">Apellido Materno Contacto</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtAMaternoContactoEmpresa" name="txtAMaternoContactoEmpresa" placeholder="Apellido Materno Contacto">
    </div>
  </div>
  <div class="form-group">
    <label for="txtCargoEmpresa" class="col-sm-3 control-label">Cargo</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtCargoEmpresa" name="txtCargoEmpresa" placeholder="Cargo">
    </div>
  </div>
  <div class="form-group">
    <label for="txtEmailContactoEmpresa" class="col-sm-3 control-label">Correo</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtEmailContactoEmpresa" name="txtEmailContactoEmpresa" placeholder="Correo de Contacto">
    </div>
  </div>
  <div class="form-group">
    <label for="txtCelularContactoEmpresa" class="col-sm-3 control-label">Celular Contacto</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtCelularContactoEmpresa" name="txtCelularContactoEmpresa" placeholder="Celular Contacto">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control" id="txtDirecccionEmpresa" name="txtDirecccionEmpresa" placeholder="Direccion Empresa">
    </div>
  </div>
  <div class="form-group">
    <label for="txtDescripcionEmpresa" class="col-sm-3 control-label">Descripci&oacute;n de la Empresa</label>
    <div class="col-sm-9">
      <textarea class="form-control" id="txtDescripcionEmpresa" name="txtDescripcionEmpresa" placeholder="Descripcion de la Empresa" rows="3"></textarea>
    </div>
  </div>
  <div class="form-group">
